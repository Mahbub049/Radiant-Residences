...
const Banner = () => {
    return (
        ...
        >
        <SwiperSlide>
            <div className='bg-[linear-gradient(45deg,rgba(19,19,24,0.50),rgba(19,19,24,0.50)),url("https://i.ibb.co/7Sg0Qqh/real-1.jpg")] bg-center bg-cover min-h-[750px] rounded-xl'>
                <div className='flex flex-col justify-center items-center h-[750px] border-2 text-center'>
        ...
        <SwiperSlide>
            <div className='bg-[linear-gradient(45deg,rgba(19,19,24,0.50),rgba(19,19,24,0.50)),url("https://i.ibb.co/2vz378m/real-2.jpg")] bg-center bg-cover min-h-[750px] rounded-xl'>
                <div className='flex flex-col justify-center items-center h-[750px] border-2 text-center'>
        ...
        <SwiperSlide>
            <div className='bg-[linear-gradient(45deg,rgba(19,19,24,0.50),rgba(19,19,24,0.50)),url("https://i.ibb.co/3CC4C1n/real-3.jpg")] bg-center bg-cover min-h-[750px] rounded-xl'>
                <div className='flex flex-col justify-center items-center h-[750px] border-2 text-center'>
